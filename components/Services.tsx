...
const icons: Record<string, JSX.Element> = {
  ...
  brush: (
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
      d="M9.53 16.122a3 3 0 0 0-5.78 1.128 2.25 2.25 0 0 1-2.4 2.245 4.5 4.5 0 0 0 8.4-2.245c0-.399-.078-.78-.22-1.128Zm0 0a15.998 15.998 0 0 0 3.388-1.62m-5.043-.025a15.994 15.994 0 0 1 1.622-3.395m3.42 3.42a15.995 15.995 0 0 0 4.764-4.648l3.876-5.814a1.151 1.151 0 0 0-1.597-1.597L14.146 6.32a15.996 15.996 0 0 0-4.649 4.763m3.42 3.42-3.42-3.42"
    />
  ),
  sparkles: (
    <path
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {services.map((service, i) => (
            <motion.div
              ...
              className="group rounded-2xl bg-white p-7 shadow-card border border-ink/5 hover:border-transparent hover:shadow-soft transition-all"
            >
              <div className="h-12 w-12 rounded-xl bg-brand-gradient-soft flex items-center justify-center mb-5 group-hover:bg-brand-gradient transition-colors">
                <svg
                  ...
                  strokeWidth={1.5}
                  stroke="currentColor"
                  className="h-6 w-6 text-brand-violet group-hover:text-white transition-colors"
                >
                  {icons[service.icon]}
                </svg>
              </div>
